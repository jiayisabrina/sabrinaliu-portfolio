            ...
            <div style={{ padding: "36px clamp(20px,5vw,64px) 32px", background: T.pinkBg, borderBottom: `1px solid ${T.pinkL}` }}>
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px,1fr))", gap: 40, alignItems: "start" }}>
                    <div>
                        ...
                        <p style={{ fontFamily: mono, fontSize: 14, lineHeight: 1.9, color: T.ink3, margin: 0, maxWidth: 440 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px,1fr))", borderBottom: `1px solid ${T.border}` }}>
                {STATS.map((s, i) => (
                    <motion.div key={i} whileHover={{ background: T.pinkBg }}
                        style={{ padding: "24px 20px", borderRight: i < 3 ? `1px solid ${T.border}` : "none", background: i % 2 === 0 ? T.bg : T.bg2, position: "relative", transition: "background 0.2s" }}>
                        ...
                        <div style={{ fontFamily: mono, fontSize: 13, letterSpacing: "0.08em", textTransform: "uppercase", color: T.ink3, lineHeight: 1.5 }}>{s.label}</div>
                    </motion.div>
                ))}
            </div>
            ...
            <div style={{ padding: "32px clamp(20px,5vw,64px)", borderBottom: `1px solid ${T.border}`, background: T.bg }}>
                ...
                {activeTab === "overview" && (
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px,1fr))", gap: 40 }}>
                        <div>
                            ...
                            <p style={{ fontFamily: mono, fontSize: 14, lineHeight: 1.9, color: T.ink3, margin: "0 0 14px" }}>
                            ...
                            <p style={{ fontFamily: mono, fontSize: 14, lineHeight: 1.9, color: T.ink3, margin: "0 0 16px" }}>
                            ...
                            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                                <div style={{ background: T.pinkBg, border: `1px solid ${T.pinkL}`, borderLeft: `3px solid ${T.pink}`, borderRadius: "0 3px 3px 0", padding: "12px 14px" }}>
                                    ...
                                    <p style={{ fontFamily: mono, fontSize: 12, lineHeight: 1.75, color: T.ink3, margin: 0 }}>Multiple articles rank on page 1 of Google for their target keywords — buying guide queries, brand comparisons, and appliance-type searches — within weeks of publication on competitive, high-volume terms.</p>
                                </div>
                                <div style={{ background: T.pinkBg, border: `1px solid ${T.pinkL}`, borderLeft: `3px solid ${T.pink}`, borderRadius: "0 3px 3px 0", padding: "12px 14px" }}>
                                    ...
                                    <p style={{ fontFamily: mono, fontSize: 12, lineHeight: 1.75, color: T.ink3, margin: 0 }}>Content cited as a source by ChatGPT, Google Gemini, and Notebook LM when answering appliance queries — a signal of factual authority and structural clarity that AI systems recognize and surface to users.</p>
                                </div>
                            </div>
                        </div>
                        <div>
                                ...
                                {[
                                    ...
                                    <div key={i} style={{ display: "flex", gap: 10, alignItems: "flex-start" }}>
                                        ...
                                        <div>
                                            ...
                                            <div style={{ fontFamily: mono, fontSize: 14, color: T.ink3, lineHeight: 1.6 }}>{c.desc}</div>
                                        </div>
                                    </div>
                                ))}
                            </div>
                ...
                {activeTab === "articles" && (
                    <div style={{ display: "flex", flexDirection: "column", gap: 1, border: `1px solid ${T.border}`, borderRadius: 3, overflow: "hidden" }}>
                        {ARTICLES.map((a, i) => (
                            <motion.div key={i} whileHover={{ background: T.pinkBg }}
                                style={{ background: i % 2 === 0 ? T.bg : T.bg2, padding: "18px 24px", borderBottom: i < ARTICLES.length - 1 ? `1px solid ${T.border}` : "none", transition: "background 0.15s" }}>
                                <div style={{ display: "grid", gridTemplateColumns: "1fr auto", gap: 16, alignItems: "start" }}>
                                    <div>
                                        ...
                                        <p style={{ fontFamily: mono, fontSize: 12, lineHeight: 1.75, color: T.ink3, margin: "0 0 8px" }}>{a.desc}</p>
                        ...
                        {SKILLS.map((s, i) => (
                            <div key={s.num} style={{
                                ...
                                <div>
                                    ...
                                    <p style={{ fontFamily: mono, fontSize: 14, lineHeight: 1.9, color: T.ink3, margin: 0, maxWidth: 640 }}>{s.body}</p>
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px,1fr))", gap: 8 }}>
                    {[
                        ...
                        <motion.div key={i} whileHover={{ background: "#fff", borderColor: T.pinkL }}
                            ...
                            <p style={{ fontFamily: mono, fontSize: 14, lineHeight: 1.8, color: T.ink2, margin: 0 }}>{o.b}</p>
                        </motion.div>
                    ))}
                </div>
            </div>
        ...
        <div style={{ borderTop: `1px solid ${T.pinkL}` }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(130px,1fr))", borderBottom: `1px solid ${T.border}` }}>
                {[
                    ...
                    <motion.div key={i} whileHover={{ background: T.pinkBg }}
                        style={{ padding: "22px 18px", borderRight: i < 5 ? `1px solid ${T.border}` : "none", background: i % 2 === 0 ? T.bg : T.bg2, position: "relative", transition: "background 0.2s" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px,1fr))", borderBottom: `1px solid ${T.border}` }}>
                <div style={{ padding: "32px 28px 32px clamp(20px,5vw,64px)", borderRight: `1px solid ${T.border}` }}>
                    ...
                    <p style={{ fontFamily: mono, fontSize: 14, lineHeight: 1.9, color: T.ink3, margin: "0 0 12px" }}>
                    ...
                    <p style={{ fontFamily: mono, fontSize: 14, lineHeight: 1.9, color: T.ink3, margin: 0 }}>
                    ...
                    {[
                        ...
                        <div key={i} style={{ display: "flex", gap: 10, marginBottom: 14, alignItems: "flex-start" }}>
                            ...
                            <div>
                                ...
                                <div style={{ fontFamily: mono, fontSize: 12, lineHeight: 1.75, color: T.ink3 }}>{p.b}</div>
                            </div>
                        </div>
                    ))}
                </div>
                    ...
                    {[
                        ...
                        <div key={d.num} style={{
                            ...
                            <div>
                                ...
                                <p style={{ fontFamily: mono, fontSize: 14, lineHeight: 1.9, color: T.ink3, margin: 0, maxWidth: 640 }}>{d.body}</p>
                            </div>
                        </div>
                    ))}
                </div>
            ...
            <div style={{ padding: "32px clamp(20px,5vw,64px)", borderBottom: `1px solid ${T.border}`, background: T.bg }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px,1fr))", gap: 1, background: T.border, border: `1px solid ${T.border}`, borderRadius: 3, overflow: "hidden" }}>
                    {[
                        ...
                        <div key={s.num} style={{ background: T.bg, padding: "22px 18px", position: "relative" }}>
                            <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 2, background: [T.pink, T.sand, T.border2, T.pinkL][i] }} />
                            ...
                            <p style={{ fontFamily: mono, fontSize: 14, lineHeight: 1.8, color: T.ink2, margin: "0 0 10px" }}>{s.body}</p>
                            <div style={{ borderLeft: `2px solid ${T.pinkL}`, paddingLeft: 10, fontFamily: mono, fontSize: 13, color: T.ink3, lineHeight: 1.6 }}>{s.detail}</div>
                        </div>
                    ))}
                </div>
            </div>
            ...
            <div style={{ padding: "32px clamp(20px,5vw,64px)", background: T.pinkBg }}>
                ...
                <div style={{ background: T.ink, borderRadius: 2, padding: "18px 22px" }}>
                    <p style={{ fontFamily: serif, fontSize: "clamp(18px,1.6vw,23px)", fontStyle: "italic", color: T.pinkL, lineHeight: 1.75, margin: 0, opacity: 0.9 }}>
        ...
        <div style={{ borderTop: `1px solid ${T.pinkL}` }}>
            ...
            <div style={{
                ...
                <div>
                    ...
                    <p style={{ fontFamily: mono, fontSize: 14, lineHeight: 1.9, color: T.ink3, margin: 0, maxWidth: 420 }}>
            ...
            <div style={{
                ...
                {SA_STATS.map((s, i) => (
                    ...
                    >
                        ...
                        <div style={{ fontFamily: mono, fontSize: 13, letterSpacing: "0.1em", textTransform: "uppercase", color: T.ink3, lineHeight: 1.5 }}>{s.label}</div>
                    </motion.div>
                ))}
            </div>
                ...
                <div style={{ padding: "36px 40px", background: T.bg2 }}>
                    ...
                    {[
                        ...
                        <div key={i} style={{ display: "flex", gap: 10, marginBottom: 10, alignItems: "flex-start" }}>
                            ...
                            <span style={{ fontFamily: mono, fontSize: 12, lineHeight: 1.75, color: T.ink3 }}>{item}</span>
                        </div>
                    ))}
                </div>
            </div>
                ...
                <div style={{ display: "flex", flexDirection: "column" }}>
                    {SA_UX.map((d, i) => (
                        <div key={d.num} style={{
                            ...
                            <div>
                                <div style={{ fontFamily: cond, fontWeight: 700, fontSize: 18, letterSpacing: "0.06em", textTransform: "uppercase", color: T.ink, marginBottom: 6 }}>{d.title}</div>
                                <p style={{ fontFamily: mono, fontSize: 14, lineHeight: 1.85, color: T.ink2, margin: 0, maxWidth: 580 }}>{d.body}</p>
                            </div>
                        </div>
                    ))}
                </div>
            ...
            <div style={{ padding: "36px 64px", borderBottom: `1px solid ${T.border}`, background: T.bg }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 1, background: T.border, border: `1px solid ${T.border}`, borderRadius: 3, overflow: "hidden" }}>
                    {SA_PROCESS.map((s, i) => (
                        <div key={s.num} style={{ background: T.bg, padding: "24px 20px", position: "relative" }}>
                            <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 2, background: [T.pink, T.sand, T.rust, T.sage][i] }} />
                            ...
                            <p style={{ fontFamily: mono, fontSize: 14, lineHeight: 1.8, color: T.ink2, margin: "0 0 12px" }}>{s.body}</p>
                            <div style={{ borderLeft: `2px solid ${T.pinkL}`, paddingLeft: 10, fontFamily: mono, fontSize: 13, color: T.ink3, lineHeight: 1.6 }}>{s.detail}</div>
                        </div>
                    ))}
                </div>
                    ...
                    <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 20 }}>
                        <div style={{ flex: 1 }}>
                            ...
                            <motion.p
                                ...
                                style={{ fontFamily: mono, fontSize: 12, lineHeight: 1.75, color: T.ink3, margin: 0, maxWidth: 560, overflow: "hidden" }}
                ...
                {project.isSelfCare ? (
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", borderTop: `1px solid ${T.pinkL}` }}>
                        ...
                        <div style={{ padding: "28px clamp(16px,3vw,40px)", display: "flex", flexDirection: "column", gap: 12 }}>
                            ...
                            <p style={{ fontFamily: mono, fontSize: 15, lineHeight: 1.85, color: T.ink3, margin: 0 }}>{project.desc}</p>
                            <motion.span
                                data-cursor="true"
                                whileHover="hover"
                                initial="rest"
        ...
        <div ref={ref}
            ...
            <motion.div
                ...
                <div style={{
                    ...
                    {/* Polaroid caption */}
                    <div style={{ fontFamily: mono, fontSize: 10, letterSpacing: "0.12em", color: T.ink3, textTransform: "uppercase", textAlign: "center", lineHeight: 1.8 }}>
                        sabrina · 2026<br />
...
function Stat({ num, label }) {
    return (
        <motion.div whileHover={{ background: T.pinkBg }} style={{ padding: "36px 28px", cursor: "default", background: T.bg2, transition: "background 0.2s" }}>
            ...
            <div style={{ fontFamily: mono, fontSize: 12, letterSpacing: "0.14em", textTransform: "uppercase", color: T.ink3, lineHeight: 1.5 }}>{label}</div>
        </motion.div>
    )
}
                                ...
                                {[
                                    ...
                                    <div key={p.n} style={{ display: "flex", gap: 0, borderBottom: i < arr.length - 1 ? `1px solid ${T.border}` : "none", paddingBottom: 18, paddingTop: i === 0 ? 0 : 18 }}>
                                        ...
                                        <div>
                                            ...
                                            <p style={{ fontFamily: mono, fontSize: 13, lineHeight: 1.75, color: T.ink3, margin: 0 }}>{p.body}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
